          ...
          },
          {
            ...
            render: (text, record) => ({
              props: highlight
                ? {
                    style: {
                      background: record.selected ? "#ceface" : "unset",
                      color: record.selected ? "unset" : "lightgrey",
                    },
                  }
                : {},
          ...
          },
          {
            ...
            render: (text, record) => ({
              props: highlight
                ? {
                    style: {
                      background: record.selected.breakfast
                        ? "#ceface"
                        : "unset",
                      color: record.selected.breakfast ? "unset" : "lightgrey",
                    },
                  }
                : {},
              children: <span>{text}</span>,
          ...
          },
          {
            ...
            render: (text, record) => ({
              props: highlight
                ? {
                    style: {
                      background: record.selected.lunch ? "#ceface" : "unset",
                      color: record.selected.lunch ? "unset" : "lightgrey",
                    },
                  }
                : {},
              children: <span>{text}</span>,
          ...
          },
          {
            ...
            render: (text, record) => ({
              props: highlight
                ? {
                    style: {
                      background: record.selected.dinner ? "#ceface" : "unset",
                      color: record.selected.dinner ? "unset" : "lightgrey",
                    },
                  }
                : {},
              children: <span>{text}</span>,
